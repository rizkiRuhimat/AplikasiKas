...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg">
                <h5 class="row mt-3 ml-3">Kas Keluar</h5>
                <hr>
                <div class="row">
                    <div class="col-md-6">
                        <form action="exp-trx.php" method="post">
                            <div class="row form-group">
                                ...
                                <div class="col">
                                    <select name="tipe" id="tipe" class="form-control">
                                        ...
                                        <?php
                                        $sql = "SELECT * FROM jenis_trx WHERE cat = 'out' ORDER BY id_trx ASC";
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col">
                                    <textarea name="ket" id="ket" class="form-control" rows="3" value=""></textarea>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
